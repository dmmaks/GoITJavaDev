...
public class Main {
    public static void main(String[] args) {
        ProductSerializer ser = new StoreProductSerializer("products.json");
        ...
        System.out.println(new StoreProductParser(new StoreProductPriceCounter(), ser)
                .calculateTotalCost("AAAAAABBBBBBBBBBBCCCCCCCCCAAAAAAAAAAA"));
    }
}
